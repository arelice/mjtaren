export default {
  ...
  "infoStar": 'This project is open source on <a class="text-blue-600 dark:text-blue-500" href="" target="_blank">Midjourney</a>, free, and based on the MIT license with no form of payment! </p><p>If you find this project helpful, please give it a Star on GitHub, thank you!',
